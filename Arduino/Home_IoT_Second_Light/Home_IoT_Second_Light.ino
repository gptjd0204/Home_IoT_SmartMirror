...
void connectMQTT() {
  ...
  // $aws/things/MyMKR3/shadow/update/delta 구독
  mqttClient.subscribe("$aws/things/MyMKR3/shadow/update/delta");
}
...
void getDeviceStatus(char* payload) {
  ...
  // $aws/things/MyMKR3/shadow/update topic으로 payload 전송
  sprintf(payload,"{\"state\":{\"reported\":{\"SERVO_STATE\":\"%s\"}}}",servoState);
}

// MQTT Client에 메시지를 보낸다.
void sendMessage(char* payload) {
  char TOPIC_NAME[]= "$aws/things/MyMKR3/shadow/update";
