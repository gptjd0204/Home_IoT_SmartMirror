...
public class HomeSecondLightLogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lightDayBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(HomeSecondLightLogActivity.this, callbackMethod, year, month, day);
        ...
        start.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new GetLightLog(HomeSecondLightLogActivity.this,getLightLogsURL).execute();
            }
        });
    }
